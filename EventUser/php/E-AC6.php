...
session_start();
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') { 
    ...
    $type = [1];
    $delete->delete("eventuser", "eventuser_id", $_SESSION['eventuser_id'], $type);
...
<body bgcolor="#f0f8ff" >
    ...
    <li><div class="box">
        <h2>アカウント消去規約</h2><br>
        株式会社ReAp(以下「当社」と記載します。)が提供する計画、イベント投稿システム「Aplan」の利用について同意していただく事項について記載しています。
        <h4>第一条　定義</h4>
        <p>1.「本システム」とは、</p>
        <p>2.「利用者」とは、本システムの利用規約に同意し、第三条において会員登録を行った地方自治体をさします。</p>
        <h4>第二条　利用</h4>
        <h4>第三条　利用</h4>
        <h4>第四条　利用</h4>
        <h4>第五条　利用</h4>
