...
<head>
    <meta charset="UTF-8" />
    <link rel="stylesheet" media="screen" href="U-HK8.css">
...
<body>
    ...
    <form action="#" method="post">
        ...
        <p align="center">
            <input type="text" name="plan_title" class="title" placeholder="タイトル">
        </p>
        ...
        <div class="box">
            ...
            <div align="right">
                <button type="button" onclick="location.href='U-HK10.html'" class="next">
                    <font size="+3">
                        次へ
                    </font>     
                </button>
