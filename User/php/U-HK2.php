...
<aside id="sub">
  <ul class="menu">
    <li class="menu-list"><a class="menu-button" href="U-HK1.php"><img src="U-menu-home.png" width="47" height="43">　ホーム</a></li><br>
    <li class="menu-list"><a class="menu-button" href="U-PL1.php"><img src="U-menu-place.png" width="47" height="43">　名所</a></li><br>
    <li class="menu-list"><a class="menu-button" href="U-EV1.php"><img src="U-menu-event.png" width="47" height="43">　イベント</a></li><br>
    <li class="menu-list"><a class="menu-button" href="U-FV1.php"><img src="U-menu-favorite.png" width="47" height="43">　お気に入り</a></li><br>
    <li class="menu-list"><a class="menu-button" href="U-AC3.php"><img src="U-menu-acount.png" width="47" height="43">　アカウント</a></li><br>
    </ul>
</aside>
